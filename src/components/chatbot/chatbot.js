...
const Chatbot = () => {
  ...
  return (
    <React.Fragment>
      ...
      <button onClick = {()=>handleRead()} className="btn btn-primary btn-sm m-2" >Read</button>
      <button onClick = {()=>handleWrite()} className="btn btn-primary btn-sm m-2" >Write</button>
    </React.Fragment>
  );
};
